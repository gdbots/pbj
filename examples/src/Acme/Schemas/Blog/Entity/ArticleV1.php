...
use Acme\Schemas\Core\Entity\ArticleV1 as AcmeCoreArticleV1;
use Acme\Schemas\Core\Entity\ArticleV1Mixin;
use Acme\Schemas\Core\Entity\ArticleV1Trait;
        ...
        return new Schema('pbj:acme:blog:entity:article:1-0-1', __CLASS__,
            [
                ...
                Fb::create('comments', T\MessageType::create())
                    ->asAList()
                    ->className('Acme\Schemas\Blog\Entity\Comment')
                    ->build()
            ],
            [
                EntityV1Mixin::create(), 
                ArticleV1Mixin::create(), 
