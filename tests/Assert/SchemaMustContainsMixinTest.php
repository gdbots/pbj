...
class SchemaMustContainsMixinTest extends \PHPUnit_Framework_TestCase
{
    public function testValidateSame()
    {
        ...
        $a->addMixin(new SchemaDescriptor('pbj:vendor2:package2:category2:message2:1-0-0'));
    ...
    public function testValidateAddon()
    {
        ...
        $b = new SchemaDescriptor('pbj:vendor:package:category:message:1-0-1');
        $b->addMixin(new SchemaDescriptor('pbj:vendor2:package2:category2:message2:1-0-0'));
        $b->addMixin(new SchemaDescriptor('pbj:vendor3:package3:category3:message3:1-0-0'));
