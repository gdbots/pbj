...
class SchemaValidExtendsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $a = new SchemaDescriptor('pbj:vendor:package:category:message:1-0-0');
        $a->setExtends(new SchemaDescriptor('pbj:vendor2:package2:category2:message2:1-0-0'));

        $b = new SchemaDescriptor('pbj:vendor:package:category:message:1-0-1');
        $b->setExtends(new SchemaDescriptor('pbj:vendor3:package3:category3:message3:1-0-0'));
